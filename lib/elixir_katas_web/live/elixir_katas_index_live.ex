defmodule ElixirKatasWeb.ElixirKatasIndexLive do
  ...
  alias ElixirKatasWeb.ElixirKataData

  def mount(_params, _session, socket) do
    sections = ElixirKataData.sections()
    ...
    {:ok,
     assign(socket,
       ...
       all_tags: ElixirKataData.all_tags()
     )}
  end
    ...
    <div class="max-w-4xl mx-auto py-8">
      ...
      <div class="mb-6 space-y-4">
        <form phx-change="search" class="relative">
          <input
            ...
            phx-debounce="200"
            class="w-full px-4 py-2 pl-10 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
          />
            ...
            <button
              ...
              class={[
                ...
                if(MapSet.member?(@active_tags, tag),
                  do: "border-emerald-500 bg-emerald-100 text-emerald-800 dark:bg-emerald-900 dark:text-emerald-200 dark:border-emerald-400",
      ...
      <%= if @filtered_sections == [] do %>
        <div class="text-center py-12">
          ...
          <button phx-click="clear_filters" class="mt-4 text-emerald-600 dark:text-emerald-400 hover:underline cursor-pointer">
            Clear filters
          </button>
        </div>
      <% end %>
      ...
      <%= for section <- @filtered_sections do %>
        <div class="mb-8">
          <h2 class="text-xl font-bold text-emerald-700 dark:text-emerald-400 mb-4 border-b border-emerald-200 dark:border-emerald-800 pb-2">
            {section.title}
          </h2>
