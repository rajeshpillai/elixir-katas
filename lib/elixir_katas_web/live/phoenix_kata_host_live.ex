defmodule ElixirKatasWeb.PhoenixKataHostLive do
  ...
  def mount(params, session, socket) do
    ...
    source_pattern = "lib/elixir_katas_web/live/phoenix_kata_#{kata_id}_*_live.ex"
    base_file =
    ...
    if base_file == nil do
      {:ok, socket |> put_flash(:error, "Phoenix Kata #{kata_id} not found.") |> push_navigate(to: ~p"/phoenix-katas")}
    else
      ...
      title =
        base_file
        |> Path.basename(".ex")
        |> String.replace("phoenix_kata_", "Kata ")
